// CROSSFIRE dashboard — live on-chain state.
...
// fabricated data. Styled to match the landing page (Bull electric blue,
// Bear hot red, Space Grotesk display, JetBrains Mono numerics).
